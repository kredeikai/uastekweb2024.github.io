...
<html lang="en">
  <head>
    ...
    <title>UAS-TeknoWeb2024</title>
    <link rel="icon" href="assets/uag.png" type="image/png">
  </head>
  <body>
    <!--Navbar-->
   <nav class="navbar fixed-top navbar-expand-lg bg-body-tertiary shadow-sm justify-space-between">
  <div class="container-fluid">
    <img src="assets/logo_perpus.jpg" alt="logo" width="50px">
    <a href="sign/login.html" class="navbar-toggler" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
    ...
    <section id="homeSection" class="p-5">
      <div class="d-flex flex-wrap justify-content-center">
        <div class="col mt-5">
         <h2 class="fw-bold text-success"><span class="text-primary">Universal</span>Perpus</h2>
          <p class="mb-4">"Temukan Dunia Pengetahuan di Ujung Jari Anda: <br> Perpustakaan Online <span class="fw-bold">UniversalPerpus</span> Membawa Anda ke Dunia Buku Digital."</p>
          <a class="btn btn-primary" href="sign/login.html">Get started</a>
        </div>
        <div class="col mt-3">
          <img src="assets/logo_dashboard.jpg" width="450px">
        </div>
      </div>
    </section>
    ...
    <section class="bg-body-secondary p-5" id="aboutSection">
      ...
      <div class="d-flex justify-content-center flex-wrap gap-4 mt-4">
        <div class="card border-info mb-3" style="max-width: 18rem;">
            <img src="assets/andi.jpg" class="card-img-top" alt="Andi Nur Akifah">
            <div class="card-body">
            <h5 class="card-title">Andi Nur Akifah</h5>
            <p class="card-text">Mahasiswa Universitas UAG</p>
            </div>
        </div>
        <div class="card border-info mb-3" style="max-width: 18rem;">
            <img src="assets/rifo.jpeg" class="card-img-top" alt="M. Dzikri Khairrifo">
            <div class="card-body">
            <h5 class="card-title">M. Dzikri Khairrifo</h5>
            <p class="card-text">Mahasiswa Universitas UAG</p>
            </div>
        </div>
    </section>
    ...
    <footer id="footer" class="p-3 bg-dark">
      <div class="row p-3">
        <div class="col mt-3">
          ...
          <p class="text-secondary fs-6">Cilandak, Jakarta Selatan, Menara 165 Lt.18</p>
        </div>
        ...
        <div class="d-flex justify-content-center align-items-center mt-3">
          <p class="text-light">Made width ❤️ <a href="" class="text-decoration-none">Universitas Ary Ginanjar</a>  2024</p>
        </div>
      </div>
    </footer>
