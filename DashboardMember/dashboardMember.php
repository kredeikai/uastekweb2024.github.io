...
<style>
  ...
  <body>
    ...
    <div class="mt-5 p-4">
      ...
      <div class="alert alert-success" role="alert">Selamat datang member - <span class="text-capitalize fw-bold"><?php echo $_SESSION['member']['nama']; ?> </span> di Dashboard UniversalPerpus</div>
  ...
  <footer class="shadow-lg bg-subtle p-3 fixed-bottom">
      <div class="container-fluid d-flex justify-content-between">
      <p class="mt-2">Created by <span class="text-primary"> Universitas Ary Ginanjar</span> © 2024</p>
