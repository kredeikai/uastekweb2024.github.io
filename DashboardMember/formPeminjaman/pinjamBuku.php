...
<html lang="en">
  ...
  <div class="p-4 mt-5">
    ...
    <div class="input-group mb-3 mt-3">
            ...
            <input type="date" name="tgl_peminjaman" id="tgl_peminjaman" class="form-control" placeholder="id_buku" aria-label="tgl_peminjaman" aria-describedby="basic-addon1" onchange="setReturnDate()" required>
      </div>
    <div class="input-group mb-3 mt-3">
    ...
    <footer class="shadow-lg bg-subtle p-3">
      ...
      <p class="mt-2">Created by <span class="text-primary"> Universtas Ary Ginanjar</span> © 2024</p>
